...
int main(int argc, char **argv)
{
	...
	char *strFileImage = "n4.jpg";	// default file
	if (argc == 2)
	...
	for (int r=0; r<rectFaces.size(); r++) {
		...
		float SHIRT_DY = 2.5f;	// Distance from top of face to top of shirt region, based on detected face height.
		float SHIRT_SCALE_X = 2.0f;	// Width of shirt region compared to the detected face
		float SHIRT_SCALE_Y = 0.9f;	// Height of shirt region compared to the detected face
		CvRect rectShirt;
		...
		if (bottom > imageIn->height-1) {
			SHIRT_DY = 1.5f;	// Distance from top of face to top of shirt region, based on detected face height.
			SHIRT_SCALE_Y = 1.0f;	// Height of shirt region compared to the detected face
