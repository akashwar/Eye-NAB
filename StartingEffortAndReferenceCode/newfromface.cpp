...
void recognizeFromCam(void)
{
	...
	#endif
		faceCascade1 = (CvHaarClassifierCascade*)cvLoad(faceCascadeFilename[0], 0, 0, 0 );
		faceCascade2 = (CvHaarClassifierCascade*)cvLoad(faceCascadeFilename[1], 0, 0, 0 );
		faceCascade3 = (CvHaarClassifierCascade*)cvLoad(faceCascadeFilename[2], 0, 0, 0 );
